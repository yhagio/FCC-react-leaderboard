...
/***/ function(module, exports, __webpack_require__) {
	...
	var TableRow = function (_Component) {
	  ...
	  function TableRow() {
	    ...
	    var _this = _possibleConstructorReturn(this, Object.getPrototypeOf(TableRow).call(this));

	    _this.state = {
	      userData: []
	    };
	    _this.fetchRecent = _this.fetchRecent.bind(_this);
	    _this.fetchAllTime = _this.fetchAllTime.bind(_this);
	    return _this;
	  }
	  ...
	  _createClass(TableRow, [{
	    ...
	    value: function fetchRecent() {
	      ...
	      fetch('http://fcctop100.herokuapp.com/api/fccusers/top/recent').then(function (response) {
	    ...
	    key: 'fetchAllTime',
	    value: function fetchAllTime() {
	      var _this3 = this;

	      fetch('http://fcctop100.herokuapp.com/api/fccusers/top/alltime').then(function (response) {
	        return response.json();
	      }).then(function (userData) {
	    ...
	    key: 'render',
	    value: function render() {
	      var userData = this.state.userData.map(function (data, index) {
	        return _react2.default.createElement(
	          'tr',
	          { key: data.username },
	          _react2.default.createElement(
	          ...
	          _react2.default.createElement(
	            'td',
	            null,
	            _react2.default.createElement('img', { src: data.img, alt: '' }),
	            data.username
	          ),
	          _react2.default.createElement(
	            'td',
...
/***/ function(module, exports, __webpack_require__) {
	...
	var TableHeader = function (_Component) {
	  ...
	  _createClass(TableHeader, [{
	    key: "handleFetchAlltime",
	    value: function handleFetchAlltime(e) {
	      this.props._fetchAllTime();
	    }
	  }, {
	    key: "handleFetchRecent",
	    value: function handleFetchRecent(e) {
	    ...
	    value: function render() {
	      return _react2.default.createElement(
	        ...
	        _react2.default.createElement(
	          ...
	          {
	            className: "clickable",
	            onClick: this.handleFetchRecent.bind(this) },
	        ...
	        _react2.default.createElement(
	          ...
	          {
	            className: "clickable",
	            onClick: this.handleFetchAlltime.bind(this) },
	          "All time points"
	        )
	      );
	    }
